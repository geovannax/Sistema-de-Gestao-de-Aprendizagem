...
| views | [HomeView](views/HomeView.md) (landing e dashboard — registrada em `/` e `/home/`), [permission_denied](views/permission_denied.md), [page_not_found](views/page_not_found.md) |
